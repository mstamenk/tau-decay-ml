...
X = df_recodata[['pi1_from_tau_pt', 'pi1_from_tau_eta', 'pi1_from_tau_phi',
                'pi2_from_tau_pt', 'pi2_from_tau_eta', 'pi2_from_tau_phi',
                'pi3_from_tau_pt', 'pi3_from_tau_eta', 'pi3_from_tau_phi']].values
Y = df_recodata[['neutrino_from_tau_pt', 'neutrino_from_tau_eta', 'neturino_from_tau_phi']].values
